  ...
  return (
    <>
      <div className="min-h-screen">
        ...
        <h1 className="text-4xl font-medium text-center mt-5 ">Hair care</h1>
        <p className="text-center mt-4 w-2/3 sm:w-1/3 mx-auto">
          Our expert stylists recommend the finest products, incorporating the
          latest hair care innovations, to help you achieve and maintain your
          dream look.
        </p>
        <div
