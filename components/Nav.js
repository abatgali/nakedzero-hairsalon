          ...
          <div className="flex sm:flex-col max-sm:gap-2">
            <div className="md:flex md:items-center md:gap-12">
              ...
              <div className="flex items-center gap-4">
                <AppointmentLink>
                  <button className="bg-orange-400 bg-opacity-30 hover:bg-transparent border-2 border-orange-400  rounded-sm rounded-tl-[20px] rounded-br-[20px] text-white px-6 py-2 text-lg mr-4 transition duration-300">
                    Book
                  </button>
                </AppointmentLink>
