              ...
              <div className="flex flex-col max-sm:backdrop-blur-sm max-sm:bg-black max-sm:bg-opacity-10 pt-4">
                ...
                <p className="mt-8 w-full max-md:px-4 md:ml-auto lg:text-xl text-normal max-md:mx-auto md:pl-2">
                  ...
                  hairstyles that capture your unique essence.
                    ...
                    products and innovative styling, all tailored to your
                    individual style.
                  </span>{" "}
                ...
                <div className="flex flex-row gap-5 sm:gap-8 max-md:mx-auto sm:ml-auto my-8 sm:mt-12 text-center md:text-xl md:font-medium text-sm font-normal">
                  <div className="w-32 md:w-[216px] md:h-[60px] bg-indigo-950 rounded-tl-[40px] rounded-br-[40px] py-4 shadow-lg hover:shadow-2xl">
                    {" "}
                    Our Products{" "}
                  </div>
                  <div className="w-36 md:w-[216px] md:h-[60px] bg-orange-400 rounded-tl-[40px] rounded-br-[40px] py-4 shadow-lg hover:shadow-2xl">
                    {" "}
                    Book Appointment
                  </div>
                </div>
